...
export default function PostPage() {
  ...
  useEffect(() => {
    const fetchPostInfo = async () => {
      try {
        const response = await axios.get(`https://mern-blog-2-9i1u.onrender.com/posts/post/${id}`);
    ...
    <section className="post-detail">
      ...
      by @{postInfo.author.username}
        ...
        <div className="post-detail__thumbnail">
          <img src={`https://mern-blog-2-9i1u.onrender.com/${postInfo.cover}`} alt="" />
        </div>
  ...
  //     <div className="image">
  //       <img src={`https://mern-blog-2-9i1u.onrender.com/posts/post/${postInfo.cover}`} alt=""/>
  //     </div>
  //     <div className="content" dangerouslySetInnerHTML={{__html:postInfo.content}} />
  //   </div>
